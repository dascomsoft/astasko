...
//                   />
//                   <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-tasko-yellow text-tasko-dark p-4 sm:p-0 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl">
